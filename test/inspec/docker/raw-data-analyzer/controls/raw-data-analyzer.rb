...
control "raw-data-analyzer" do
  impact 1.0
  title "raw-data-analyzer container check"
  ...
  describe sys_info do
    its('hostname') { should eq 'raw-data-analyzer.scissor-project.com' }
  end
  ...
  init_script_path_content = '/opt/start-raw-data-analyzer.sh'
